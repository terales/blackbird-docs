...
Check downloadable workflow prototypes featuring this app that you can import to your Nests [here](../eggs/tms-to-llm/). 
...
3. Since October 2024, users can rely on [Checkpoints](../concepts/checkpoints/#large-language-models-llms--batch-processing) to achieve a fully streamlined process. A Checkpoint can pause the workflow until the LLM returns a result or a batch process completes. 
