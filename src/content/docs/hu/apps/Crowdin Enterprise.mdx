...
> Kérjük, vegye figyelembe, hogy a Crowdin Enterprise alkalmazás elavult. Jelenleg a két Crowdin alkalmazást egyetlen [Crowdin alkalmazásba](../apps/crowdin/) olvasztottuk össze, és határozottan javasoljuk, hogy a Crowdin Enterprise helyett a Crowdin alkalmazást használja.
