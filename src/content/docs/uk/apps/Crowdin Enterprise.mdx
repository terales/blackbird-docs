...
> Зверніть увагу, що додаток Crowdin Enterprise застарів. Наразі ми об'єднали два додатки Crowdin в один [додаток Crowdin](https://docs.blackbird.io/apps/crowdin/), і ми настійно рекомендуємо використовувати додаток Crowdin замість Crowdin Enterprise.
