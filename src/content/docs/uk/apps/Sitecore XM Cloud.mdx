...
Цей додаток розроблено для Sitecore XP. Для Sitecore XM Cloud див. [цей посібник](https://docs.blackbird.io/apps/sitecore-xp/).
...
- Ви завантажили останній пакет плагіна Blackbird Sitecore [звідси](https://docs.blackbird.io/sitecore/package.zip).
...
1. Розпакуйте файли з [package.zip](https://docs.blackbird.io/sitecore/package.zip)
