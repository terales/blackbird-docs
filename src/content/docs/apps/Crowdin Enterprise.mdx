---
  ...
  description: The Crowdin Enterprise Blackbird app
---
...
> Please note, the Crowdin Enterprise app is deprecated. We have currently merged the two Crowdin apps into one [Crowdin app](../apps/crowdin/), and we strongly recommend using the Crowdin app instead of Crowdin Enterprise.
