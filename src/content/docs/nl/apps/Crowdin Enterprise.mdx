...
> Let op, de Crowdin Enterprise app is verouderd. We hebben momenteel de twee Crowdin apps samengevoegd tot één [Crowdin app](https://docs.blackbird.io/apps/crowdin/), en we raden sterk aan om de Crowdin app te gebruiken in plaats van Crowdin Enterprise.
