...
This app is built for Sitecore XP. For Sitecore XM Cloud see [this guide](../apps/sitecore-xp/) instead.
...
- You have downloaded the latest Blackbird Sitecore plugin package from [here](../sitecore/package.zip).
...
1. Extract the files from [package.zip](../sitecore/package.zip)
