---
  locale: nl
  title: Pipedrive
  description: De Pipedrive Blackbird app
---
import { LinkCard } from "@astrojs/starlight/components";

<LinkCard title="View on Github" target="_blank" href="https://github.com/bb-io/Pipedrive" icon="github" />

Pipedrive is een customer relationship management (CRM) platform ontworpen om verkoopprocessen te stroomlijnen en de productiviteit van verkoopteams te verbeteren. Het biedt een reeks functies, waaronder taakautomatisering, aanpasbare pijplijnen, contactbeheer en realtime inzichten via dashboards.
